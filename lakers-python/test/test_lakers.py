...
def test_initiator():
    ...
    message_1 = initiator.prepare_message_1(c_i=None, ead_1=EADItem.new_many_py())
...
def _test_handshake(cred_r_transfer, cred_i_transfer):
    ...
    message_3, i_prk_out = initiator.prepare_message_3(cred_i_transfer, EADItem.new_many_py())
    ...
    message_4 = responder.prepare_message_4(EADItem.new_many_py())
