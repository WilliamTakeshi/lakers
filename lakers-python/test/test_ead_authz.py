...
def test_handshake_with_authz():
    ...
    # initiator
    ead_1 = lakers.EADItem.new_many_py()
    ...
    voucher_response = enrollment_server.handle_voucher_request(voucher_request)
    ead_2 = lakers.EADItem.new_many_py()
    ...
    message_3, i_prk_out = initiator.prepare_message_3(lakers.CredentialTransfer.ByReference, lakers.EADItem.new_many_py())
