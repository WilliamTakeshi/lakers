...
> nRF54L15 boards are expected to talk *to each other*, not to an nRF52840. The driver has been
...
an nRF54L15 and an nRF52840 *can* in principle interoperate. Doing so reliably requires the on-air
